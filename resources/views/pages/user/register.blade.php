    ...
    <div class="auth-container">
        ...
        <form>
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="fullname" id="floating_fullname" class="block py-2.5 px-0 w-full text-base text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
