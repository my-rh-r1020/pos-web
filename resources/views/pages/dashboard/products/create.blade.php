...
<div class="mb-8 text-grayText">
    <h3 class="content-title">New Product</h3>
</div>
<div class="bg-[#fff] rounded-md p-4">
    <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div>
                <div class="relative mb-5">
                    <input type="text" id="floating_name" name="product_name" value="{{ old('product_name') }}" class="form-input border-1 peer" placeholder=" " />
                ...
                <div class="relative mb-5">
                    <input type="number" id="floating_stock" name="stock" value="{{ old('stock') }}" class="form-input border-1 peer" placeholder=" " />
                ...
                <div class="relative mb-5">
                    <input type="number" id="floating_price" name="price" value="{{ old('price') }}" class="form-input border-1 peer" placeholder=" " />
        ...
        <div>
            <button type="submit" class="mt-4 md:mt-0 submit-btn">Create</button>
        </div>
    </form>
</div>
@endsection
