            ...
            <div>
                ...
                <div class="mb-5">
                    ...
                    <ul class="grid md:grid-cols-3 gap-2 lg:gap-4">
                        <li>
                            <input type="radio" id="admin" name="role" value="admin" class="hidden peer" checked />
                        ...
                        <li>
                            <input type="radio" id="staff" name="role" value="staff" class="hidden peer">
                        ...
                        <li>
                            <input type="radio" id="user" name="role" value="user" class="hidden peer">
