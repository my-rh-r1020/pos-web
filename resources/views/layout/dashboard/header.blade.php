<section class="header-section">
    <div class="px-4 py-2">
        <div class="flex justify-end pr-2 gap-x-2">
            <img id="avatarBtn" type="button" data-dropdown-toggle="avatarDropdown" data-dropdown-placement="bottom-start" src="{{ asset('storage/profile-image/'.auth()->user()->avatar) }}" alt="" class="w-10 h-10 rounded-full cursor-pointer">
            ...
            <div id="avatarDropdown" class="z-20 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-48">
                ...
                <ul class="py-2 text-sm text-grayText " aria-labelledby="avatarBtn">
                  ...
                  <li class="hover:bg-sky-600 hover:text-white">
                    <a href="{{ route('users.edit',auth()->user()->id) }}" class="block px-4 py-2">Settings</a>
                  </li>
                </ul>
                <div class="py-1">
